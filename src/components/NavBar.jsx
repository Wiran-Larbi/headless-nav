                ...
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-stretch sm:items-center justify-center sm:justify-start">
                                        ...
                                        {navigation.map((item) => (
                                            item.name === "Solutions"
                                                ...
                                                <a
                                                    key={item.name}
                                                    href={item.href}
                                                    className='text-opacity-90 text-cyan-700 px-3 py-2 text-base font-medium hover:text-opacity-100 hover:text-cyan-500 focus:outline-none'
                            ...
                            {navigation.map((item) => (
                                item.name === "Solutions"
                                    ...
                                    <Disclosure.Button
                                        ...
                                        as="a"
                                        href={item.href}
                                        className='text-cyan-700  hover:text-cyan-500 block px-3 py-2 text-lg font-medium'
                                        aria-current={item.current ? 'page' : undefined}
                                    >
                                        {item.name}
                                    </Disclosure.Button>
